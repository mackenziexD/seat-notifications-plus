...
class StructureLostArmor extends AbstractNotification
{
    ...
    public function toSlack($notifiable)
    {
        return (new SlackMessage)
            ...
            ->content("The {$type->typeName} **{$structureName}** in {$this->zKillBoardToDiscordLink('system',$system->itemID,$system->itemName)} ({$region}) has lost its shields. Hull timer end at: **{$timeLeft}**.")
