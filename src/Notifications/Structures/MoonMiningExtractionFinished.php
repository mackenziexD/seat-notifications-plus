...
class MoonMiningExtractionFinished extends AbstractDiscordNotification
{
    ...
    public function populateMessage(DiscordMessage $message, $notifiable)
    {
        $message->embed(function (DiscordEmbed $embed) {
            ...
            $description = "The extraction for **{$structureName}** at {$planet} in {$this->zKillBoardToDiscordLink('system',$system->itemID,$system->itemName)} ({$region}) is finished and the chunk is ready to be shot at. The chunk will automatically fracture on **${$autoFrac}**.\n\n";
